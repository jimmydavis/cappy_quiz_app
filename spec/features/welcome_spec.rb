...
describe 'A page called JavaScript' do
  ...
  describe "clicking the click me button with JavaScript enabled", :js => true do
...
describe 'A page called Quizzes' do
  ...
  it "allows user to fill in numbers separated by commas" do
    fill_in 'user_input', with: '1, 2, 3'
    expect(page).to have_field('user_input', with: '1, 2, 3')
  end
